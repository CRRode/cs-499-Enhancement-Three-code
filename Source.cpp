...
int main()
{
	...
	/* Modified 4/5/2024
	Created sphere that was copied from 'shapeCode' database
	this code is an example of the functionality of the shape code database.
	this code is from the Shape_Data collum in the "Shapes" table. */
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		Created sphere that was copied from 'shapeCode' database
		this code is an example of the functionality of the shape code database. 
		this code is from the Shape_render collum in the "Shapes" table. */
